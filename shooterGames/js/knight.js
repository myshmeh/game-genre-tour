class Knight extends Enemy {
    ...
    {
        super(scene, x, y, 'sprites', 1, addBullet, removeBullet, removeSelf, behaviours);
        this.power = 1;
        this.speed = 75;
    }
    ...
    launch() {
        ...
        const bullet = new Bullet(this.scene, this.x, this.y, 'sprites', 1, 
        ...
        const bullet2 = new Bullet(this.scene, this.x, this.y, 'sprites', 1, 
